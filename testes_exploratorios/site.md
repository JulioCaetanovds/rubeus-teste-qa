...
* **Anexo:** `![Print do Top Bar com redundância](./imagens/imagem_topbar.png)`
...
* **Anexo:** `![Print dos links Institucional e Biblioteca](./imagens/imagem_icones_topo.png)`
...
* **Anexo:** `![Print do carrossel com botões inativos](./imagens/imagem_carrossel.png)`
...
* **Anexo:** `![Print do desalinhamento no card de pesquisas](./imagens/imagem_diferenciais_desalinhado.png)`
...
* **Anexo:** `![Print dos cards com baixo contraste](./imagens/imagem_diferenciais_sombras.png)`
...
* **Anexo:** `![Print da imagem com fundo cinza na seção de eventos](./imagens/imagem_eventos_fundo.png)`
...
* **Anexo:** `![Print do evento Vestibular 2022](./imagens/imagem_evento_2022.png)`
...
* **Anexo:** `![Print da inconsistência de aspas nos eventos](./imagens/imagem_eventos_aspas.png)`
...
* **Anexo:** `![Print do campo telefone com letras](./imagens/imagem_telefone_newsletter.png)`
...
* **Anexo:** `![Print do erro no envio da newsletter](./imagens/imagem_erro_newsletter.png)`
...
* **Anexo:** `![Print do layout colado na newsletter](./imagens/imagem_layout_newsletter.png)`
